...
class ViroARSceneNavigatorClass extends React.Component {
     ...
     * @platform ios
     */
    _setRenderFrameRate = (fps) => {
        ViroARSceneNavigatorModule.setRenderFrameRate((0, react_native_1.findNodeHandle)(this), fps);
    };
     ...
     */
    _getFrameDataWithOptions = async (frameId, options) => {
        return await ViroARSceneNavigatorModule.getFrameDataWithOptions((0, react_native_1.findNodeHandle)(this), frameId, options ?? {});
    };
    /**
