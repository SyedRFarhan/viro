 ...
 * [iOS Only]
 */
export type ViroWorldMapErrorCode = "NOT_FOUND" | "NOT_SUPPORTED" | "DECODE_FAILED" | "SESSION_UNAVAILABLE" | "BUSY" | "WORLD_MAP_NOT_READY";
/**
 ...
 */
export type ViroWorldMappingStatus = "notAvailable" | "limited" | "extending" | "mapped";
/**
...
export interface ViroARSceneNavigatorHandle {
     ...
     * ```
     */
    triggerScanWave(config?: import("../AR/ViroARSceneNavigator").ViroScanWaveConfig & {
        repeatCount?: number;
